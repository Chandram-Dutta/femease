...
class MentalQuestionPage extends ConsumerStatefulWidget {
  const MentalQuestionPage({
    super.key,
  ...
  @override
  ConsumerState<MentalQuestionPage> createState() => _MentalQuestionPageState();
}

class _MentalQuestionPageState extends ConsumerState<MentalQuestionPage> {
