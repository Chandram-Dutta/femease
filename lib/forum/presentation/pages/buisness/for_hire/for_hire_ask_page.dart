...
class ForHireAskPage extends ConsumerStatefulWidget {
  const ForHireAskPage({super.key});

  @override
  ConsumerState<ForHireAskPage> createState() => _ForHireAskPageState();
}

class _ForHireAskPageState extends ConsumerState<ForHireAskPage> {
