...
class ForHireQuestionPage extends ConsumerStatefulWidget {
  const ForHireQuestionPage({
    super.key,
    required this.mentalQuestion,
  });

  final DocumentSnapshot<Map<String, dynamic>> mentalQuestion;

  @override
  ConsumerState<ForHireQuestionPage> createState() =>
      _ForHireQuestionPageState();
}

class _ForHireQuestionPageState extends ConsumerState<ForHireQuestionPage> {
  ...
  Widget build(BuildContext context) {
    final QuestionModel questionModel = QuestionModel.fromDocumentSnapshot(
      widget.mentalQuestion,
    );
    ...
    return Scaffold(
      appBar: AppBar(
        title: ref.watch(getUserProvider(questionModel.askedBy)).when(
              data: (data) => Text(
                "Asked by ${data.name}",
              ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Asked on ${DateFormat.yMMMMd().format(questionModel.askedWhen)}",
              ),
