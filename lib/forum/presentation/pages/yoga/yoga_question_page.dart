...
class YogaQuestionPage extends ConsumerStatefulWidget {
  const YogaQuestionPage({
    super.key,
  ...
  @override
  ConsumerState<YogaQuestionPage> createState() => _YogaQuestionPageState();
}

class _YogaQuestionPageState extends ConsumerState<YogaQuestionPage> {
