...
import 'package:femease/forum/presentation/pages/fun/fun_ask_page.dart';
import 'package:femease/forum/presentation/pages/fun/fun_question_page.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const FunAskPage(),
          ),
        ),
        label: const Text("Ask"),
        icon: const Icon(Icons.add),
      ),
      body: ref.watch(forumListProvider("fun")).when(
                ...
                return ListTile(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => FunQuestionPage(
