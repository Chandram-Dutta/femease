...
class FunAskPage extends ConsumerStatefulWidget {
  const FunAskPage({super.key});

  @override
  ConsumerState<FunAskPage> createState() => _FunAskPageState();
}

class _FunAskPageState extends ConsumerState<FunAskPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Ask a Fun Question"),
      ),
