...
class FunQuestionPage extends ConsumerStatefulWidget {
  const FunQuestionPage({
    super.key,
  ...
  @override
  ConsumerState<FunQuestionPage> createState() => _FunQuestionPageState();
}

class _FunQuestionPageState extends ConsumerState<FunQuestionPage> {
