...
class FitnessAskPage extends ConsumerStatefulWidget {
  const FitnessAskPage({super.key});

  @override
  ConsumerState<FitnessAskPage> createState() => _FitnessAskPageState();
}

class _FitnessAskPageState extends ConsumerState<FitnessAskPage> {
